...
user in an INI file next to WiseFolderHiderPortable.exe called WiseFolderHiderPortable.ini.
...
copy AppNamePortable.ini from this directory to WiseFolderHiderPortable.ini next to
WiseFolderHiderPortable.exe. The options in the INI file are as follows:
